  ...
  <div style="position : absolute; top : 10px; width : 1000px; background:white;">
    ...
    <div id="rightaside">
      ...
      <table class="TDrightTable">
        ...
        <!-- <tr v-if="task_id === 33">
          <td style="background:lightgrey;"> Agg Type </td>
          <td>
        ...
        <tr v-if="task_id === 33">
          <td style="background:lightgrey;"> Agg Unit </td>
          <td> <input style="width : 95%;" type="text" v-model="otype_0_ip" v-on:keyup.enter="createDIV2"></td>
        </tr> -->
        <!-- <tr>
        ...
        <tr v-if="output_type === '0'">
          ...
          <td> <input style="width : 95%;" type="text" v-model="otype_0_port" v-on:keyup.enter="createDIV2"></td>
        </tr>

        <!-- file output -->
        <tr v-if="output_type === '1'">
          <td style="background:lightgrey;"> 출력파일명 </td>
          <td> <input style="width : 95%;" type="text" v-model="otype_1_file" v-on:keyup.enter="createDIV2"></td>
        </tr>

        <!-- DB output -->
        <tr v-if="output_type === '2'">
          <td style="background:lightgrey;"> DB IP </td>
          <td> <input style="width : 95%;" type="text" v-model="otype_2_ip" v-on:keyup.enter="createDIV2"></td>
        </tr>
        <tr v-if="output_type === '2'">
          <td style="background:lightgrey;"> DB 명 </td>
          <td> <input style="width : 95%;" type="text" v-model="otype_2_name" v-on:keyup.enter="createDIV2"></td>
        </tr>
        <tr v-if="output_type === '2'">
          <td style="background:lightgrey;"> DB ID </td>
          <td> <input style="width : 95%;" type="text" v-model="otype_2_id" v-on:keyup.enter="createDIV2"></td>
        </tr>
        <tr v-if="output_type === '2'">
          <td style="background:lightgrey;"> DB PW </td>
          <td> <input style="width : 95%;" type="text" v-model="otype_2_pw" v-on:keyup.enter="createDIV2"></td>
        </tr>
        <tr v-if="output_type === '2'">
          <td style="background:lightgrey;"> Table 명 </td>
          <td> <input style="width : 95%;" type="text" v-model="otype_2_table" v-on:keyup.enter="createDIV2"></td>
        </tr>

        <!-- <tr>
          <td style="width : 80px;" class="add_title"> CONFIG </td>
          <td> <input style="width : 95%;" type="text" v-model="config" v-on:keyup.enter="createDIV2"> </td>
        </tr>
        <tr>
          <td style="width : 80px;" class="add_title"> HB TASK </td>
          <td> <input style="width : 95%;" type="text" v-model="heartbeat_task" v-on:keyup.enter="createDIV2"></td>
        </tr>
        <tr>
          <td style="width : 80px;" class="add_title"> HB JOB </td>
          <td> <input style="width : 95%;" type="text" v-model="heartbeat_job" v-on:keyup.enter="createDIV2"></td>
        </tr>
        <tr>
      ...
      <button style="height:40px; width:200px; font-size:14px;" class="JobDetailHeaderbutton" v-on:click="func_test"> 확인1 </button>
    </div>
    ...
    <div id="modify_SO">
      ...
      <table style="margin:auto; align:center;">
        ...
        <tr>
          <td style="width : 80px;" class="add_title"> Input Queue Size </td>
          <td> <input style="width : 95%;" type="text" v-model="SOInputQueueSize"></td>
        </tr>
        <tr>
          <td style="width : 80px;" class="add_title"> 출력 서버 </td>
          <td> <input style="width : 95%;" type="text" v-model="SOServer"></td>
        </tr>
        <tr>
          <td style="width : 80px;" class="add_title"> 리스닝 포트 </td>
          <td> <input style="width : 95%;" type="text" v-model="SOPort"></td>
        </tr>
      </table>
      <br> <br>
      <button id="modifyButton" v-on:click="modifyTask_reload"> SAVE </button>
...
var cntxtmenu;
var modify_menu;
var modify_BS, modify_Proj, modify_SO, modify_Agg, modify_HJ, modify_BJ, modify_TR, modify_BS2;
var cntxtmenuID;
var t;
var taskArray = [];
var lineArray = [];
...
$(function() {
  ...
  modify_BS2 = document.getElementById("modify_BS2");
...
export default {
  ...
  methods : {
    ...
    modifyTask_reload() {
      ...
      console.log("modifyTask called");
      console.log("task id : " + this.temptask_id);
      var id = this.jobId;
      var _this = this;
      new Promise(function(resolve, reject){
        // Socket Output
        if(_this.temptask_id == 0) {
          _this.putAggConfig(0);
        }
        else {
          if(_this.temptask_id == 1) {
            _this.putAggConfig(1);
          }
          // Projection
          if(_this.temptask_id == 2) {
            _this.putAggConfig(2);
            // var temp = _this.tempArr.join('	');
            // _this.tempconfig = JSON.stringify(temp);
          }
          // Aggregation
          if(_this.temptask_id == 4) {
            _this.putAggConfig(4);
          }
          // Transaction
          if(_this.temptask_id == 6) {
            _this.putAggConfig(6);
          }
          // Half JOIN
          if(_this.temptask_id == 31) {
            _this.putAggConfig(31);
          }
          // Binary JOIN
          if(_this.temptask_id == 12) {
            _this.putAggConfig(12);
          }
        }
        // else {
        //   _this.putAggConfig(0);
    ...
    putAggConfig(index) {
      ...
      if(index == 0) {
        ...
        var str = JSON.stringify(this.tempconfig);
        ...
        if(index == 1) {
          var SOData = [];
          SOData.push(this.SOServer);
          SOData.push(this.SOPort);
          SOData.push(this.SOInputQueueSize);

          var SOData2 = new Object();
          SOData2 = {
            server : this.SOServer,
            port : this.SOPort,
            inputQueueSize : this.SOInputQueueSize
          }

          // console.log(SOData2);
          // this.tempconfig = JSON.stringify(SOData2);
          // console.log(this.tempconfig);
          ...
          //   inputQueueSize : this.SOInputQueueSize
          // }
          var str = JSON.stringify(SOData2);
          this.tempconfig = JSON.stringify(str);
          console.log(this.tempconfig);
          // this.tempconfig = JSON.stringify(SOData);
          // console.log(this.tempconfig);
        }
        if(index == 2) {
          var str = _this.tempArr.join('	');
          _this.tempconfig = JSON.stringify(str);
        }
        if(index == 4) {
          console.log("HERE");
          var str = JSON.stringify(this.AggTOTALQueryData);
          console.log(this.AggTOTALQueryData);
          this.tempconfig = JSON.stringify(str);
        }
        if(index == 6) {
    ...
    updateModifyTask() {
      console.log("update modify task");
      console.log(this.tempconfig);
      if(this.tempconfig == "") {
        this.tempconfig = JSON.stringify(" ");
      }
      console.log("!!! : " + this.tempoutput_schema);
      localStorage.removeItem("loglevel:webpack-dev-server");
    ...
    showModifyMenu(index, op_type) {
      switch(op_type) {
        ...
        case 33:  modify_menu = modify_BS2; break;
    ...
    loadModifyData(index) {
      ...
      if(arr[2] == 1) {
        ...
        this.SOServer = temp.server;
        this.SOPort = temp.port;
        this.SOInputQueueSize = temp.inputQueueSize;
      }
      if(arr[2] == 4) {
        console.log("$$$$$");
        var temp = JSON.parse(this.tempconfig);
