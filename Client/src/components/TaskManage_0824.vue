  ...
  <div>
    <div>
      ...
      <div style="width:33%; height:500px; float:left;">
        ...
        <form v-if="add_window" action="http://localhost:3000/users/tasks/add" method="post" enctype="multipart/form-data">
          <table class="mainMngTable2" style="margin:auto; width:95%;">
            <tr>
              ...
              <td> <input style="width : 92%;" name="name" type="text" v-model="addTName"> </td>
              <td> <button class="midBtn" v-on="taskname_check"> Check </button> </td>
            ...
            <tr>
              ...
              <td colspan="2"> <input style="width:95%;" type="text" name="comment" v-model="addComment"/> </td>
        ...
        <div>
          <table>
            <tr v-for="(input, index) in add_params">
              <input type="text" v-model="add_params.one"> - {{ add_params.one }}  
              <input type="text" v-model="add_params.two"> - {{ add_params.two }}
